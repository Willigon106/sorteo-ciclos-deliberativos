...
function App() {
  ...
  const [ganadoresMujeresAdulta, setGanadoresMujeresAdulta] = useState([]);
  const [ganadoresMujeresMayores, setGanadoresMujeresMayores] = useState([]);
  const [ganadoresHombres, setGanadoresHombres] = useState([]);
  ...
  return (
    <div className="contenedor">
      <h1 className="titulo">Participantes - Bosa</h1>
      <h1 className="titulo">3 cupos</h1>

      {/* Bloque Hombres jovenes */}
      <h2 className="subtitulo">Hombre Joven de estrato bajo</h2>
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            ...
            onClick={(e) => sortear(hombresJovenes, setGanadoresHombres, 4, e, "Hombre Joven de estrato bajo")}
          >
            Comenzar sorteo
          </button></div>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            type="button"
            className="btn-comenzar"
            onClick={(e) => sortear(mujeresAdultos, setGanadoresMujeresAdulta, 4, e, "Mujer Adulta de estrato bajo")}
          >
            Comenzar sorteo
          </button></div>

          {ganadoresMujeresAdulta.length > 0 && (
            <div className="ganadores">
              <h3>Seleccionados</h3>
              <p className="titular">
                <strong>Titular:</strong> {ganadoresMujeresAdulta[0][0]} - {ganadoresMujeresAdulta[0][5]}<br></br>{ganadoresMujeresAdulta[0][7]}
              </p>
              <ul>
                {ganadoresMujeresAdulta.slice(1).map((g, idx) => (
                  <li key={idx}>
                    <strong>Suplente {idx + 1}:</strong> {g[0]} - {g[5]}<br></br>{g[7]}
                  </li>
                ))}
      ...
      <h2 className="subtitulo">Mujer Mayor de estrato bajo</h2>
      <div className="contenido">
        <div className="tabla-container">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            type="button"
            className="btn-comenzar"
            onClick={(e) => sortear(mujeresMayores, setGanadoresMujeresMayores, 4, e, "Mujer Mayor de estrato bajo")}
          >
            Comenzar sorteo
          </button></div>
