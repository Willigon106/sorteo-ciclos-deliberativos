      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            ...
            onClick={(e) => sortearMujeresAdultas(mujeresAdultos, setGanadoresMujeresAdultas, 3, e, "Mujer adulta y mayor de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            type="button"
            className="btn-comenzar"
            onClick={(e) => sortear(hombresAdultos, setGanadoresHombresAdultos, 3, e,"Hombre adulto y mayor de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
