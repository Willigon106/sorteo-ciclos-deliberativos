 ...
 // const [todosLosGanadores, setTodosLosGanadores] = useState([]);
  ...
  useEffect(() => {
    leerYFiltrarExcel().then(({ filtrados }) => {
      ...
      const filtroAdultos = filtrados.filter(
        (fila) =>
          fila[12]?.trim().toLowerCase() === "antonio nariño" &&
      ...
      setMujeresAdultas(filtroAdultos);
  ...
  return (
    <div className="contenedor">
      <h1 className="titulo">Participantes - Antonio Nariño</h1>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            ...
            onClick={(e) => sortear(mujeresAdultas, setGanadoresMujeres, 4, e, "Mujer Adulta de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
