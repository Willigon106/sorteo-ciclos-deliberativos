...
//  const [todosLosGanadores, setTodosLosGanadores] = useState([]);
  useEffect(() => {
    leerYFiltrarExcel().then(({ filtrados }) => {
      ...
      const filtroAdultos = filtrados.filter(
        (fila) =>
          fila[12]?.trim().toLowerCase() === "engativá" &&
      ...
      // Hombres
      const filtroAdultosh = filtrados.filter(
        (fila) =>
          fila[12]?.trim().toLowerCase() === "engativá" &&
      ...
      setHombresAdultos(filtroAdultosh);
    });
  }, []);
  ...
  return (
    <div className="contenedor">
      <h1 className="titulo">Participantes - Engativá</h1>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            ...
            onClick={(e) => sortearMujeresAdultas(mujeresAdultos, setGanadoresMujeresAdultas, 2, e,"Mujer adulta y mayor de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            type="button"
            className="btn-comenzar"
            onClick={(e) => sortear(hombresAdultos, setGanadoresHombresAdultos, 2, e, "Hombre adulto y mayor de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
