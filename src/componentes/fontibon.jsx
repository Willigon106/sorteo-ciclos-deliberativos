...
//  const [todosLosGanadores, setTodosLosGanadores] = useState([]);
  useEffect(() => {
    leerYFiltrarExcel().then(({ filtrados }) => {
      ...
      const filtroJovenes = filtrados.filter(
        (fila) =>
          fila[12]?.trim().toLowerCase() === "fontibón" &&
  ...
  return (
    <div className="contenedor">
      <h1 className="titulo">Participantes - Fontibón</h1>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            ...
            onClick={(e) => sortear(mujeresJovenes, setGanadoresMujeres, 1, e,"Mujer adulta y mayor de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
          ...
          {ganadoresMujeres.length > 0 && (
            <div className="ganadores">
              <h3>Seleccionados</h3>
              <p className="titular">
                <strong>Titular:</strong> {ganadoresMujeres[0][0]} - {ganadoresMujeres[0][5]}<br></br>{ganadoresMujeres[0][7]}
              </p>
              <ul>
      ...
      <div className="contenido">
        ...
        <div className="sorteo-container">
          <div className="boton-container"> <button
            type="button"
            className="btn-comenzar"
            onClick={(e) => sortear(hombresAdultos, setGanadoresHombres, 1, e, "Hombre Adulto de estrato bajo y medio")}
          >
            Comenzar sorteo
          </button></div>
