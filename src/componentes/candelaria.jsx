...
function App() {
 ...
 // const [todosLosGanadores, setTodosLosGanadores] = useState([]);
  ...
  /*const descargarTXT = () => {
    ...
    let contenido = "📋 LISTA DE SELECCIONADOS - Localidad La Candelaria\n\n";
    ...
    enlace.download = "seleccionados-Candelaria.txt";
    enlace.click();
  };*/

  return (
    <div className="contenedor">
      <h1 className="titulo">Participantes - La Candelaria</h1>
